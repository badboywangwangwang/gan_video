...
public class Config {
    ...
    /** 包名：controller */
    public static final String PACKAGE_NAME_CONTROLLER = "controller.admin";
    ...
    /** 作者 */
    public static final String AUTHOR = "Gan";

    /** 基础包名 */
    public static final String PACKAGE_NAME = "com.gan";
    ...
    /** xml输出目录 */
    public static final String OUTPUT_XML = PROJECT_PATH + "/src/main/resources/mapper";

    /** 数据库类型 */
    public static final DbType DB_TYPE = DbType.MYSQL;

    /** 数据库链接 */
    public static final String DB_URL = "jdbc:mysql://127.0.0.1:3306/gan_video?useOldAliasMetadataBehavior=true&serverTimezone=Asia/Shanghai&zeroDateTimeBehavior=convertToNull&useSSL=false&characterEncoding=gbk&allowPublicKeyRetrieval=true";
